...
import 'dart:io';
import 'package:driver_app/modules/signup_screen/upload_attatchments/driver_lisence/driver_lisence_front.dart';
...
class UploadNationalIdBackScreen extends StatefulWidget {
  const UploadNationalIdBackScreen({Key? key}) : super(key: key);

  @override
  UploadNationalIdBackScreenState createState() =>
      UploadNationalIdBackScreenState();
}

class UploadNationalIdBackScreenState
    extends State<UploadNationalIdBackScreen> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: defaultTextButton(
                          ...
                          textFunction: () {
                            nationalIdBack = image?.path;
                            print('***********************');
                            print(nationalIdBack);
                            print('***********************');
                            if (nationalIdBack == null) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: ((context) =>
                                      const UploadDriverLisenceFrontScreen()),
                                ),
                              );
                            }
                          },
