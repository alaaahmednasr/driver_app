...
import 'dart:io';
import 'package:driver_app/modules/signup_screen/upload_attatchments/national_id/national_id_back.dart';
import 'package:driver_app/modules/signup_screen/upload_attatchments/start_screen/start_screen.dart';
...
class UploadNationalIdFrontScreen extends StatefulWidget {
  const UploadNationalIdFrontScreen({Key? key}) : super(key: key);

  @override
  UploadNationalIdFrontScreenState createState() =>
      UploadNationalIdFrontScreenState();
}

class UploadNationalIdFrontScreenState
    extends State<UploadNationalIdFrontScreen> {
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: defaultTextButton(
                              ...
                              textFunction: () {
                                nationalIdFront = image?.path;
                                print('***********************');
                                print(nationalIdFront);
                                print('***********************');
                                if (nationalIdFront == null) {
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: ((context) =>
                                          const UploadNationalIdBackScreen()),
                                    ),
                                  );
                                }
                              },
