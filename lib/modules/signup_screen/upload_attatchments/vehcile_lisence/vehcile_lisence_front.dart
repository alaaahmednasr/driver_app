...
import 'package:driver_app/modules/signup_screen/upload_attatchments/vehcile_lisence/vehcile_lisence_back.dart';
...
class UploadVechileLisenceFrontScreen extends StatefulWidget {
  const UploadVechileLisenceFrontScreen({Key? key}) : super(key: key);

  @override
  UploadVechileLisenceFrontScreenState createState() =>
      UploadVechileLisenceFrontScreenState();
}

class UploadVechileLisenceFrontScreenState
    extends State<UploadVechileLisenceFrontScreen> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: defaultTextButton(
                          ...
                          textFunction: () {
                            vehcileLisenceFront = image?.path;

                            print('***********************');
                            print(vehcileLisenceFront);
                            print('***********************');
                            if (vehcileLisenceFront == null) {
                              ...
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                  builder: ((context) =>
                                      const UploadVechileLisenceBackScreen()),
                                ),
                              );
                            }
                          },
