// ignore_for_file: avoid_print, unused_field, unnecessary_this, deprecated_member_use, unused_local_variable

import 'dart:io';
import 'package:conditional_builder_null_safety/conditional_builder_null_safety.dart';
import 'package:driver_app/modules/signup_screen/upload_attatchments/driver_lisence/driver_lisence_back.dart';
...
class UploadVechileLisenceBackScreen extends StatefulWidget {
  const UploadVechileLisenceBackScreen({Key? key}) : super(key: key);

  @override
  UploadVechileLisenceBackScreenState createState() =>
      UploadVechileLisenceBackScreenState();
}

class UploadVechileLisenceBackScreenState
    extends State<UploadVechileLisenceBackScreen> {
        ...
        if (state is SignupScusessState) {
          if (state.signUpModel.success!) {
           ...
           if (!state.signUpModel.status!) {
            ...
            Fluttertoast.showToast(
                msg: "${getLang(context, "phone_used")}",
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM,
                timeInSecForIosWeb: 1,
                backgroundColor: Colors.black45,
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          textPoppinsMedium(
                            text: "${getLang(context, "vehcile_lisence")}",
                            fontSize: 25,
                            textColor: const Color(0XFF43494B),
                          ),
                          const SizedBox(
                          ...
                          textPoppinsRegular(
                            text: "${getLang(context, "vehcile_id")}",
                            fontSize: 18,
                            textColor:
                                const Color(0XFF43494B).withOpacity(0.76),
                          ),
                          ...
                          ConditionalBuilder(
                            ...
                            builder: (context) => Container(
                              ...
                              child: defaultTextButton(
                                ...
                                textFunction: () {
                                  vehcileLisenceBack = image?.path;
                                  if (vehcileLisenceBack == null) {
                                    Fluttertoast.showToast(
                                    ...
                                    getCubit.userSignUp(
                                      ...
                                      userName: userName!,
                                      password: password!,
                                      nationalIdFrontpath: nationalIdFront!,
                                      nationalIdBackpath: nationalIdBack!,
                                      driverFrontpath: driverLisenceFront!,
                                      vehicleFrontpath: vehcileLisenceFront!,
                                    );
                                  }
                                },
                              ),
