...
import 'package:driver_app/modules/signup_screen/upload_attatchments/vehcile_lisence/vehcile_lisence_front.dart';
...
class UploadDriverLisenceBackScreen extends StatefulWidget {
  const UploadDriverLisenceBackScreen({Key? key}) : super(key: key);

  @override
  UploadDriverLisenceBackScreenState createState() =>
      UploadDriverLisenceBackScreenState();
}

class UploadDriverLisenceBackScreenState
    extends State<UploadDriverLisenceBackScreen> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: defaultTextButton(
                          ...
                          textFunction: () {
                            driverLisenceBack = image?.path;

                            print('***********************');
                            print(driverLisenceBack);
                            print('***********************');
                            if (driverLisenceBack == null) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: ((context) =>
                                      const UploadVechileLisenceFrontScreen()),
                                ),
                              );
                            }
                          },
